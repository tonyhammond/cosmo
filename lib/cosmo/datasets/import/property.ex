defmodule Cosmo.Datasets.Import.Property do
  @moduledoc """
  Imports CSV data from priv/csv/properties.csv

  CSV file originally sourced from:

  https://data.cityofnewyork.us/api/views/ikqj-pyhc/rows.csv
  """
  ...
  def read_properties_file() do
    ...
    |> Enum.map(fn row ->
      ...
      params = %{
        ...
        comparable_rental_1_building_classification:
          String.trim(comparable_rental_1_building_classification),
        comparable_rental_1_dist_from_coop_in_miles:
          to_float(String.trim(comparable_rental_1_dist_from_coop_in_miles)),
        comparable_rental_1_est_gross_income:
          to_integer(String.trim(comparable_rental_1_est_gross_income)),
        comparable_rental_1_full_market_value:
          to_integer(String.trim(comparable_rental_1_full_market_value)),
        comparable_rental_1_gross_income_per_sqft:
          to_float(String.trim(comparable_rental_1_gross_income_per_sqft)),
        comparable_rental_1_gross_sqft: to_integer(String.trim(comparable_rental_1_gross_sqft)),
        comparable_rental_1_market_value_per_sqft:
          to_float(String.trim(comparable_rental_1_market_value_per_sqft)),
        ...
        comparable_rental_2_building_classification:
          String.trim(comparable_rental_2_building_classification),
        comparable_rental_2_dist_from_coop_in_miles:
          to_float(String.trim(comparable_rental_2_dist_from_coop_in_miles)),
        comparable_rental_2_est_gross_income:
          to_integer(String.trim(comparable_rental_2_est_gross_income)),
        comparable_rental_2_full_market_value:
          to_integer(String.trim(comparable_rental_2_full_market_value)),
        comparable_rental_2_gross_income_per_sqft:
          to_float(String.trim(comparable_rental_2_gross_income_per_sqft)),
        comparable_rental_2_gross_sqft: to_integer(String.trim(comparable_rental_2_gross_sqft)),
        comparable_rental_2_market_value_per_sqft:
          to_float(String.trim(comparable_rental_2_market_value_per_sqft)),
        ...
        manhattan_condominium_property_address:
          String.trim(manhattan_condominium_property_address),
        manhattan_condominium_property_boro_block_lot:
          String.trim(manhattan_condominium_property_boro_block_lot),
        manhattan_condominium_property_building_classification:
          String.trim(manhattan_condominium_property_building_classification),
        manhattan_condominium_property_condo_section:
          String.trim(manhattan_condominium_property_condo_section),
        manhattan_condominium_property_est_gross_income:
          to_integer(String.trim(manhattan_condominium_property_est_gross_income)),
        manhattan_condominium_property_full_market_value:
          to_integer(String.trim(manhattan_condominium_property_full_market_value)),
        manhattan_condominium_property_gross_income_per_sqft:
          to_float(String.trim(manhattan_condominium_property_gross_income_per_sqft)),
        manhattan_condominium_property_gross_sqft:
          to_integer(String.trim(manhattan_condominium_property_gross_sqft)),
        manhattan_condominium_property_market_value_per_sqft:
          to_float(String.trim(manhattan_condominium_property_market_value_per_sqft)),
        manhattan_condominium_property_neighborhood:
          String.trim(manhattan_condominium_property_neighborhood),
        manhattan_condominium_property_total_units:
          to_integer(String.trim(manhattan_condominium_property_total_units)),
        manhattan_condominium_property_year_built:
          to_integer(String.trim(manhattan_condominium_property_year_built)),
        nta: String.trim(nta),
